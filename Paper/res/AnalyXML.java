...
//        newR1.element("rPr").element("rStyle").addAttribute("w:val", "a7");
...
//        newR2.element("rPr").element("rFonts").addAttribute("w:hint", "eastAsia");
    ...
    public AnalyXML addCommentsToDoc(Element p, String paraId) {
        ...
        if(pNode != null) {
            ...
            newR.addAttribute("w:rsidR", "00EE00D8");
    ...
    public AnalyXML output(Document document, String path) throws IOException {
        ...
        XMLWriter writer = new XMLWriter(new OutputStreamWriter(new FileOutputStream(path + "_result"), "UTF-8"), format);
